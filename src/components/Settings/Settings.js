...
export default function Settings() {
  ...
  const [newCodewarsUsername, setNewCodewarsUsername] = useState(profile.codewars_username)
    ...
    <div className='settings-page'>
      <div className='profile'>
        <div className="profile-header">
          <h2>Settings</h2>
          <button onClick={navigateToMyDays} className="profile-button" >Return to My Days</button>
        </div>
        ...
        <div className='profile-edit-options'>
          ...
          <div className='privacy-field'>
            <label htmlFor="profile-visibility">Let Anyone View My Days Of Code Profile (Coming Soon)</label>
